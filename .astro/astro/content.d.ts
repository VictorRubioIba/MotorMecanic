...
"fr copy/insight-1.md": {
	id: "fr copy/insight-1.md";
  slug: "fr-copy/insight-1";
  body: string;
  collection: "insights";
  data: InferEntrySchema<"insights">
} & { render(): Render[".md"] };
"fr copy/insight-2.md": {
	id: "fr copy/insight-2.md";
  slug: "fr-copy/insight-2";
  body: string;
  collection: "insights";
  data: InferEntrySchema<"insights">
} & { render(): Render[".md"] };
"fr copy/insight-3.md": {
	id: "fr copy/insight-3.md";
  slug: "fr-copy/insight-3";
  body: string;
  collection: "insights";
  data: InferEntrySchema<"insights">
} & { render(): Render[".md"] };
